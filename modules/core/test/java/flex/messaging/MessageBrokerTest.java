...
public class MessageBrokerTest extends TestCase
{
    ...
    public void testAddServiceTypeExists()
    {
        try
        {
            RemotingService svc1 = new RemotingService();
            svc1.setId("remoting-service1");
            broker.addService(svc1);
            RemotingService svc2 = new RemotingService();
            svc2.setId("remoting-service2");
            broker.addService(svc2);
        ...
        {
            int error = 11113; // MessageBroker.SERVICE_TYPE_EXISTS;
