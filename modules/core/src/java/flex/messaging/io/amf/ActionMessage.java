...
/**
 * This class represents a protocol message with its collection of
 * headers and bodies.
 *
...
public class ActionMessage implements Serializable
{
    ...
    /**
     * Create a message using the current protocol version
     * and UTF-8 encoding.
     */
     ...
     *
     * @param version protocol version of current message
     */
     ...
     *
     * @param pos MessageHeader position [0, getHeaderCount())
     ...
     *         Note: primarily for use by the MessageProcessor
     */
     ...
     *
     * @param pos MessageBody position [0, getBodyCount())
     ...
     *
     * @return The bodies as an ArrayList
     *         Note: primarily for use by the MessageProcessor
     */
