...
/**
 * Serializes a Throwable as a Status Info object, which is sent
 * back to the client as an ActionScript object with the following
 * keys:
 * <ul>
 * <li>code: We report this as <code>Server.Processing</code>.
 * To be expanded in a future version.</li>
 * <li>description: The error message.</li>
 * <li>details: The error stack trace.</li>
 * <li>type: The error class name.</li>
 * <li>rootcause: If the exception was a ServletException,
 * the rootcause will be included as a nested Status Info object.</li>
 * </ul>
 */
