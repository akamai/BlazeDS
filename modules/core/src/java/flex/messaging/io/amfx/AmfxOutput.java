...
public class AmfxOutput extends AbstractAmfOutput implements AmfxTypes
{
    ...
    protected HashMap<TraitsInfo, Object> traitsTable;
    protected HashMap<String, Object> stringTable;
    ...
    public AmfxOutput(SerializationContext context)
    {
        ...
        traitsTable = new HashMap<TraitsInfo, Object>(10);
        stringTable = new HashMap<String, Object>(64);
    }
    ...
    public void writeObject(Object o) throws IOException
    {
        ...
        else
        {
            ...
            {
                writeMapAsECMAArray((Map<Object, Object>)o);
            }
            else if (o instanceof Collection)
            {
                if (context.legacyCollection)
                    writeCollection((Collection<Object>)o, null);
                else
                    writeArrayCollection((Collection<Object>)o, null);
            }
            else if (cls.isArray())
            {
    ...
    protected void writeAMFByte(int b) throws IOException
    {
      Hex.Encoder encoder = new Hex.Encoder(1);
      encoder.encode(new byte[] { (byte)b });
      String hex = encoder.drain();
    ...
    protected void writeAMFBytes(byte[] b) throws IOException
    {
      writeAMFBytes(b, 0, b.length);
    }
    
    protected void writeAMFBytes(byte[] b, int offset, int length) throws IOException
    {
      Hex.Encoder encoder = new Hex.Encoder(length);
      encoder.encode(b, offset, length);
      String hex = encoder.drain();
    ...
    protected void writeAMFChar(int c) throws IOException
    {
      StringBuilder sb = new StringBuilder();
      sb.append("<char>");
      sb.append((char)c);
    ...
    protected void writeAMFChars(String s) throws IOException
    {
      StringBuilder sb = new StringBuilder();
      sb.append("<chars>");
      sb.append(s);
    ...
    protected void writeAMFShort(int s) throws IOException
    {
      StringBuilder sb = new StringBuilder();
      sb.append("<short>");
      sb.append(s);
    ...
    protected void writeAMFLong(long l) throws IOException
    {
      StringBuilder sb = new StringBuilder();
      sb.append("<long>");
      sb.append(l);
    ...
    protected void writeAMFFloat(float f) throws IOException
    {
      StringBuilder sb = new StringBuilder();
      sb.append("<float>");
      sb.append(f);
     ...
     * @exclude
     */
    protected void writeMapAsECMAArray(Map<Object, Object> map) throws IOException
    {
     ...
     * @exclude
     */
    protected void writeArrayCollection(Collection<Object> col, SerializationDescriptor desc) throws IOException
    {
        if (!byReference(col))
        {
            ArrayCollection ac;
    ...
    protected void writeCustomObject(Object o) throws IOException
    {
        ...
        if (o instanceof PropertyProxy)
        {
            ...
            {
                if (context.legacyCollection)
                    writeCollection((Collection<Object>)o, proxy.getDescriptor());
                else
                    writeArrayCollection((Collection<Object>)o, proxy.getDescriptor());
                return;
            }
    ...
    protected void writePropertyProxy(PropertyProxy pp, Object instance) throws IOException
    {
        ...
        if (externalizable)
        {
            ((Externalizable)instance).writeExternal(new ExternalizableObjectOutput());
        }
     ...
     * in hexadecimal form, i.e. &#xFFFF. Since the maximum chrac
     *
     ...
     * @exclude
     */
    protected void writeCollection(Collection<Object> c, SerializationDescriptor descriptor) throws IOException
    {
        if (!byReference(c))
        {
    ...
    private class ExternalizableObjectOutput implements ObjectOutput
    {
        @Override
        ...
        {
            writeAMFBytes(s.getBytes("UTF-8"));
        }
        ...
        {
            AmfxOutput.this.writeObject(obj);
        }
