...
public class ThrottleManager extends ManageableComponent
{
     ...
     *
     * @param msg Message to be throttled.
     ...
     *
     * @param msg The message to be throttled.
     * @param clientId The id of the client that the message is intended to.
     * @return The result of the throttling.
     */
     ...
     *
     * @param policy The integer representing the policy.
    ...
    /**
     * ThrottleMark is used to keep track of the message rates for destinations
     * and clients of those destinations.
     */
    class ThrottleMark
    {
        Object id;
         ...
         *
         * @param id Either the destination or the client id associated with the ThrottleMark.
         */
